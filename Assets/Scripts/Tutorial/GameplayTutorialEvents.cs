...
public class GameplayTutorialEvents
{
    ...
    public event Action<DraggableClosedPastel> PastelClosed = delegate { };
    public event Action<DraggableClosedPastel> PastelPickedUp = delegate { };
    public event Action<DraggableClosedPastel> PastelDropped = delegate { };
    ...
    public void PublishPastelClosed(DraggableClosedPastel pastel) => PastelClosed(pastel);
    public void PublishPastelPickedUp(DraggableClosedPastel pastel) => PastelPickedUp(pastel);
    public void PublishPastelDropped(DraggableClosedPastel pastel) => PastelDropped(pastel);
